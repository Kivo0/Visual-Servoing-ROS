...
class ARFollower():
	...
	def set_cmd_vel(self,msg):
		...
		if (self.marker_id==5):
			...
			if ((target_offset_x - self.goal_x) > self.x_threshold and self.sm_markerFlag == False and self.stopSearchingTargetLostFlag == False):
		...
		if((self.stopmoving==True) and (self.move_cmd.linear.x>=-0.01) and (self.move_cmd.linear.x<=0.01) and (self.parkingfinished == False)):
